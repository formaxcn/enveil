...
document.querySelector<HTMLDivElement>('#app')!.innerHTML = `
  <div class="container">
    ...
    <div class="content">
      <button id="configure-btn" class="configure-button">Configuration Settings</button>
    </div>
    
    <div class="footer">
      <a href="https://github.com/formaxcn/enveil" target="_blank" id="github-link">
        <svg id="github-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
function updateIconColor(isEnabled: boolean) {
  if (isEnabled) {
    githubIcon.style.filter = 'grayscale(0%)';
  } else {
